...
```{r 1. Formulating a function for the Analyse model}
...
```{r 5a. Create Missing values 5b. Imputations methods function}
set.seed(123)
...
true.estimates <- function(x){
  ...
  return(c(y.mean, y.mean - y.mean, y.mean - INT, y.mean + INT, y.var, x1.beta, x1.beta.se, x2.beta, x2.beta.se, x3.beta, x3.beta.se, x4.beta, x4.beta.se,
       ...
       # return(c(y.mean, y.mean - y.mean, y.mean - INT, y.mean + INT, y.var, 
        #         x1.beta, x2.beta, x3.beta, x4.beta, 
         #        x1.beta.se, x2.beta.se, x3.beta.se, x4.beta.se, 
          #       r.squared, res.var, rmse, y.coverage, x1.coverage, x2.coverage, x3.coverage, x4.coverage, x1.ciw, x2.ciw, x3.ciw, x4.ciw
           #      )) 
}
```
